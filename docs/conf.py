...
print("Inserted path:", sys.path[0])
sys.path.insert(0, os.path.abspath("../frontend"))
sys.path.insert(0, os.path.abspath("../backend"))
# -- Project information -----------------------------------------------------

project = "SMILES-TO-IUPAC-name translator web application"
version = app.__version__
current_year = datetime.today().year
copyright = "2024-{}, Kohulan Rajan at the Friedrich Schiller University Jena".format(
    current_year,
)
...
html_favicon = "../frontend/public/STOUT.svg"
html_logo = "../frontend/public/STOUT.png"
